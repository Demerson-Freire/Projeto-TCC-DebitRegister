...
public class BuscaCpfCompras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busca_cpf_compras);
        ...
        Toolbar toolbar = findViewById(R.id.toolbarBuscaCpfCompras);
        txtNomeCliente = findViewById(R.id.txtGetNomeClienteBuscaNomeCpfCompras);
        btnBuscarCliente = findViewById(R.id.btnBuscarNomeClienteNomeCpfCompras);
        txtListaNomesCPF = findViewById(R.id.txtListaNomeCpfCompras);
        ...
        txtListaNomesCPF.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (cliente != null && cliente.length >= 2) {
                ...
                Intent intent = new Intent(BuscaCpfCompras.this, ListaCompras.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = new MenuInflater(BuscaCpfCompras.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuPrincipal){
            Intent intent = new Intent(BuscaCpfCompras.this, MenuPrincipal.class);
            startActivity(intent);
            finish();
            return true;
        } else if (id == R.id.LogoutHistorico){
            AlertDialog.Builder alert = new AlertDialog.Builder(BuscaCpfCompras.this);
            alert.setTitle("AVISO!");
            alert.setMessage("Deseja realmente se desconectar?");
            alert.setPositiveButton("Sim", (dialog, which) -> {
                mAuth.signOut();
                Intent intent = new Intent(BuscaCpfCompras.this, LoginAdm.class);
                startActivity(intent);
                finish();
            });
        ...
        call.enqueue(new Callback<List<Object[]>>() {
            ...
            public void onResponse(@NonNull Call<List<Object[]>> call, @NonNull Response<List<Object[]>> response) {
                if (response.isSuccessful()) {
                    ...
                    ClienteAdapter adapter = new ClienteAdapter(BuscaCpfCompras.this, R.layout.views_nomes_deleta_cliente, clientes);
                    txtListaNomesCPF.setAdapter(adapter);
                } else {
                    Toast.makeText(BuscaCpfCompras.this, "Erro ao buscar clientes", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(@NonNull Call<List<Object[]>> call, @NonNull Throwable t) {
                Toast.makeText(BuscaCpfCompras.this, "Falha na requisição", Toast.LENGTH_SHORT).show();
            }
        });
    }
