...
public class BuscaCpfRegistraPagamento extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = new MenuInflater(BuscaCpfRegistraPagamento.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuPrincipal){
            Intent intent = new Intent(BuscaCpfRegistraPagamento.this, MenuPrincipal.class);
            startActivity(intent);
            finish();
            return true;
        } else if (id == R.id.LogoutHistorico){
            AlertDialog.Builder alert = new AlertDialog.Builder(BuscaCpfRegistraPagamento.this);
            alert.setTitle("AVISO!");
            alert.setMessage("Deseja realmente se desconectar?");
            alert.setPositiveButton("Sim", (dialog, which) -> {
                mAuth.signOut();
                Intent intent = new Intent(BuscaCpfRegistraPagamento.this, LoginAdm.class);
                startActivity(intent);
                finish();
            });
