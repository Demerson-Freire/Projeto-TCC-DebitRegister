...
public class BuscaCpfRegistraCompra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busca_cpf_registra_compra);
        ...
        txtListaNomesCPF.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (cliente != null && cliente.length >= 2) {
                ...
                Intent intent = new Intent(BuscaCpfRegistraCompra.this, CadastroCompra.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = new MenuInflater(BuscaCpfRegistraCompra.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menuPrincipal){
            Intent intent = new Intent(BuscaCpfRegistraCompra.this, MenuPrincipal.class);
            startActivity(intent);
            finish();
            return true;
        } else if (id == R.id.LogoutHistorico){
            AlertDialog.Builder alert = new AlertDialog.Builder(BuscaCpfRegistraCompra.this);
            alert.setTitle("AVISO!");
            alert.setMessage("Deseja realmente se desconectar?");
            alert.setPositiveButton("Sim", (dialog, which) -> {
                mAuth.signOut();
                Intent intent = new Intent(BuscaCpfRegistraCompra.this, LoginAdm.class);
                startActivity(intent);
                finish();
            });
        ...
        call.enqueue(new Callback<List<Object[]>>() {
            ...
            public void onResponse(@NonNull Call<List<Object[]>> call, @NonNull Response<List<Object[]>> response) {
                if (response.isSuccessful()) {
                    ...
                    ClienteAdapter adapter = new ClienteAdapter(BuscaCpfRegistraCompra.this, R.layout.views_nomes_deleta_cliente, clientes);
                    txtListaNomesCPF.setAdapter(adapter);
                } else {
                    Toast.makeText(BuscaCpfRegistraCompra.this, "Erro ao buscar clientes", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(@NonNull Call<List<Object[]>> call, @NonNull Throwable t) {
                Toast.makeText(BuscaCpfRegistraCompra.this, "Falha na requisição", Toast.LENGTH_SHORT).show();
            }
        });
    }
